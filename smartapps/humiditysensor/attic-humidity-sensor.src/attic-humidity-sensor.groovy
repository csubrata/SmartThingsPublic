/**
 *  Attic Humidity Sensor
 *
 *  Copyright 2017 Subrata Baguli
 *
 ...
 */
definition(
    name: "Attic Humidity Sensor",
    namespace: "humiditysensor",
    author: "Subrata Baguli",
    description: "REST endpoint for Pi to update a Simulated Humidity Sensor",
...
preferences {
    section("Allow Endpoint to Control This Thing") {
        input "tdevice", "capability.temperatureMeasurement", title: "Which Simulated Humidity Sensor?", multiple: false
    }
}
...
private void update(device) {
     ...
     if (location.temperatureScale == params['units']) {
        log.debug "yes, the humidityScale is the same (${params['units']})"
